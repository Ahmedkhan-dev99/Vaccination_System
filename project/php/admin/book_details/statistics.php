...
$output .= '<div class="col-md-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="rounded-circle p-3" style="background: linear-gradient(45deg, #11cb54, #25fc94);">
                                <i class="fas fa-check-circle fa-2x" style="color: white;"></i>
                            </div>
                            <div class="ms-3">
                                <h6 class="mb-1" style="color: #11cb54;">Completed</h6>
                                <h3 class="mb-0" style="color: #25fc94;">'.$total_completed_vaccinations.'</h3>
                            </div>
                        </div>
                    </div>
                </div>
